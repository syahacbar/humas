...
class Agenda_surat_keluar_model extends CI_Model
{

    public $table = 'agenda_surat_keluar';
    public $id = 'id';
    public $order = 'DESC';
    ...
    // datatables
    function json() {
        $this->datatables->select('id,tgl_surat,no_surat,tujuan,perihal,hub_surat_lain,kode_arsip');
        $this->datatables->from('agenda_surat_keluar_view');
	...
	$this->db->or_like('hub_surat_lain', $q);
...
/* Location: ./application/models/Agenda_surat_keluar_model.php */
