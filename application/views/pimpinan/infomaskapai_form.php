    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
                <div class="box box-warning box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">INFORMASI KEBERANGKATAN</h3>
                    </div>
                    <form action="<?php echo $action; ?>" method="post">
            
                    <table class='table table-bordered'>    
                        <tr><td width='200'>Tgl Penerbangan <?php echo form_error('tgl_penerbangan') ?></td><td><input type="date" class="form-control" name="tgl_penerbangan1" id="tgl_penerbangan1" placeholder="Tgl Penerbangan" value="<?php echo $tgl_penerbangan1; ?>" /></td></tr>
            ...
            <div class="col-md-6">
                <div class="box box-warning box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">INFORMASI KEPULANGAN</h3>
                    </div>
                </div>
            </div>
        </div>
