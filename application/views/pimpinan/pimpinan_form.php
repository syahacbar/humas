...
<table class='table table-bordered'>        
	    ...
	    <tr><td width='200'>Nama <?php echo form_error('nama') ?></td><td><input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" value="<?php echo $nama; ?>" <?php echo $this->uri->segment(1)=="info_maskapai"?'readonly="readonly"':'';?>/></td></tr>
	    
		<?php if($this->uri->segment(1)=="info_maskapai") { ?>
	    ...
	    <a href="<?php echo $this->uri->segment(1)=='info_maskapai' ? site_url('info_maskapai') : site_url('pimpinan'); ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>