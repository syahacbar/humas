...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Info_kepulangan Read</h2>
        <table class="table">
	    <tr><td>Tlg Penerbangan</td><td><?php echo $tlg_penerbangan; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('info_kepulangan') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>