...
<html>
    <head>
        ...
        <title>SI-Humas Keprotokolan</title>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo base_url() ?>" class="logo">
                    ...
                    <span class="logo-lg"><b>SI</b>-Humas Keprotokolan</span>
                </a>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a class="btn btn-default btn-flat" href="<?php echo base_url('user/update/').$this->session->userdata('id_users');?>">Profile</a>
                                        </div>
            ...
            <footer class="main-footer">
                <div class="pull-right hidden-xs">
                    <b>Version</b> 1.1-2020
                </div>
                <strong>Copyright &copy; 2020 | SMK Negeri 1 Manokwari | Developed by Papeda Entrepreneur Creative
